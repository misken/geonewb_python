...
In this section you will get an overview of the GIS software landscape. After this, you should 
be able to:
...
### Commercial software
  ...
  * Pitney Bowes produced [MapInfo Professional](https://www.pitneybowes.com/us/location-intelligence/geographic-information-systems/mapinfo-pro.html),
...
### Online + Cloud computing
  ...
  * Google has created [Google Earth Engine (GEE)](https://earthengine.google.com/) which
  ...
  * Microsoft has created the [Planetary Computer](https://planetarycomputer.microsoft.com/) which is similar to GEE but focuses on open standards such as the STAC catalog for organizing and finding geospatial data. It is heavily Python focused and its compute takes place in a JupyterHub. Both GEE and the Planetary Computer are free for academic and personal use. 
  * [ArcGIS Online](https://www.arcgis.com/features/features.html) provides access to
  thousands of maps and base layers.
  
You can find a [comparison of GEE and the Planetary Computer](https://mapscaping.com/microsofts-planetary-computer-vs-google-earth-engine-a-compare-and-contrast/) at the Mapscaping blog.
...
programming language. This is the approach we will be using throughout this module.
...
Below are lists of some of the key spatial packages for Python.
...
See [https://en.wikipedia.org/wiki/GIS_file_format](https://en.wikipedia.org/wiki/GIS_file_format) for more about GIS file formats.
