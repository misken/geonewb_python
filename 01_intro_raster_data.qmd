...
There are two primary data types that we will learn about for storing geospatial data - raster and vector data. We will start out learning about raster data. Our objective are:
...
of the R ecosystem for geospatial as then you can pick and choose your tools as you see fit. R and Python are becoming
...
will be discussed in more detail in [the next section](02_intro_vector_data.md).
...
We will discuss these attributes in more detail in [a later section](06_working_raster_data.md).
...
In a multi-band dataset, the individual band rasters will always have the same extent,
resolution, and CRS.
