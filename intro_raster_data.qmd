...
There are two primary data types that we will learn about for storing geospatial data - raster and vector data. We will start out learning about raster data. 
...
Earth's surface (e.g. boundaries, bodies of water, roads, buildings, ...), and
assign attributes to those features. Vector data structures
will be discussed in more detail in [the next section](02-intro-vector-data.md).
...
1. Extent
2. Resolution
3. Coordinate Reference System (CRS) - we will introduce this concept in [a later section](03-crs.md)
