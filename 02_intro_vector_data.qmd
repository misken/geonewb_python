...
locations, the location of individual buildings, or the location of bathrooms.
...
The basic idea behind [GeoPandas](https://geopandas.org/en/stable/) is to combine the capabilities of pandas with the **shapely** library to allow you to work with geospatial data in a **pandas**-like way.
